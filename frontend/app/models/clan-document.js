// app/models/clan-document.js

import Model, { attr } from '@ember-data/model';

export default class ClanDocumentModel extends Model {
  // Game identifier (e.g., "TN3.1")
  @attr('string') game;

  // Clan number as string ("0134")
  @attr('string') clanNo;

  // File name with extension
  @attr('string') documentName;

  // document-type: "turn-report-file", "turn-report-extract", "worldographer-map", etc.
  @attr('string') documentType;

  // processing-status: "uploaded" | "processing" | "success" | "failed"
  ...
  get isTurnReportFile() {
    return this.documentType?.startsWith('turn-report-file');
  }

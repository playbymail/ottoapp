    ...
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
      <li>
        <ul role="list" class="-mx-2 space-y-1">
          <li>
            ...
            <LinkTo @route="dashboard" class={{this.linkClass "dashboard" "group flex gap-x-3 rounded-md"}}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class={{this.iconClass "dashboard" "size-6 shrink-0"}}>
          ...
          <li>
            <LinkTo @route="team" class={{this.linkClass "team" "group flex gap-x-3 rounded-md"}}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class={{this.iconClass "team" "size-6 shrink-0"}}>
          ...
          <li>
            <LinkTo @route="projects" class={{this.linkClass "projects" "group flex gap-x-3 rounded-md"}}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class={{this.iconClass "projects" "size-6 shrink-0"}}>
          ...
          <li>
            <LinkTo @route="calendar" class={{this.linkClass "calendar" "group flex gap-x-3 rounded-md"}}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class={{this.iconClass "calendar" "size-6 shrink-0"}}>
          ...
          <li>
            <LinkTo @route="maps" class={{this.linkClass "maps" "group flex gap-x-3 rounded-md"}}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class={{this.iconClass "maps" "size-6 shrink-0"}}>
          ...
          <li>
            <LinkTo @route="reports" class={{this.linkClass "reports" "group flex gap-x-3 rounded-md"}}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class={{this.iconClass "reports" "size-6 shrink-0"}}>
      ...
      <li>
        ...
        <ul role="list" class="-mx-2 mt-2 space-y-1">
          <li>
            <LinkTo @route="teams/heroicons" class={{this.linkClass "teams/heroicons" "group flex gap-x-3 rounded-md"}}>
          ...
          <li>
            <LinkTo @route="teams/tailwindlabs" class={{this.linkClass "teams/tailwindlabs" "group flex gap-x-3 rounded-md"}}>
              <span class="flex size-6 shrink-0 items-center justify-center rounded-lg border border-gray-200 bg-white text-[0.625rem] font-medium text-gray-400 group-hover:border-indigo-600 group-hover:text-indigo-600 dark:border-white/10 dark:bg-white/5 dark:group-hover:border-white/20 dark:group-hover:text-white">T</span>
              <span class="truncate">Tailwind Labs</span>
            </LinkTo>
          </li>
          <li>
            <LinkTo @route="teams/workcation" class={{this.linkClass "teams/workcation" "group flex gap-x-3 rounded-md"}}>
              <span class="flex size-6 shrink-0 items-center justify-center rounded-lg border border-gray-200 bg-white text-[0.625rem] font-medium text-gray-400 group-hover:border-indigo-600 group-hover:text-indigo-600 dark:border-white/10 dark:bg-white/5 dark:group-hover:border-white/20 dark:group-hover:text-white">W</span>
      ...
      <li class="mt-auto">
        <LinkTo @route="settings" class={{this.linkClass "settings" "group -mx-2 flex gap-x-3 rounded-md"}}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class={{this.iconClass "settings" "size-6 shrink-0"}}>

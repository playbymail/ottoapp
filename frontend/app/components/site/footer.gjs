    ...
    <footer class="mt-16 sm:mt-32">
      <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <nav aria-label="Footer" class="-mb-6 flex flex-wrap justify-center gap-x-12 gap-y-3 text-sm/6">
          <LinkTo @route="about" class="text-gray-600 hover:text-gray-900">About</LinkTo>
        ...
        <p class="mt-10 text-center text-sm/6 text-gray-600">&copy; 2025 Michael D Henderson. All rights reserved.</p>
      </div>
    </footer>
  </template>
}

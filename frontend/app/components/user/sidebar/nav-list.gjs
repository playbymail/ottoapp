// app/components/user/sidebar/nav-list.gjs
    ...
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
      <li>
        <ul role="list" class="-mx-2 space-y-1">
          ...
          <li>
            <LinkTo @route="user.extracts" class={{this.linkClass "user.extracts" "group flex gap-x-3 rounded-md"}}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                   data-slot="icon"
                   aria-hidden="true" class={{this.iconClass "user.extracts" "size-6 shrink-0"}}>
      ...
      <li class="mt-auto">
        ...
        {{#if this.session.canAccessGMRoutes}}
          <LinkTo @route="gm.dashboard" class={{this.linkClass "user.settings"
                                                               "group -mx-2 flex gap-x-3 rounded-md"}}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                 aria-hidden="true" class={{this.iconClass "user.settings" "size-6 shrink-0"}}>
              <path stroke-linecap="round" stroke-linejoin="round"

...
To avoid copying substrings, tokens carry **spans** into the original buffer.
Text is resolved **lazily** (e.g., for debug printing or messages).
...
func (s Span_t) Text(src []byte) string {
...
func (t Token_t) Text(src []byte) string {
	return t.Span.Text(src)
}

type TokenKind_t string // Tribe, ClanID, etc
```
...
// Text is a helper for diagnostics / debugging.
func (t Trivia_t) Text(src []byte) string {
    return t.Span.Text(src)
}

type TriviaKind_t string  // Whitespace, LineComment, BlockComment 
```
...
```
[0] Token_t{Kind: KeywordCurrent, Text: "Current", Span: [0..7]}
[1] Trivia{Kind: Whitespace, Text: " ", Span: [7..8]}
[2] Token_t{Kind: KeywordTurn, Text: "Turn", Span: [8..12]}
[3] Trivia{Kind: Whitespace, Text: " ", Span: [12..13]}
[4] Token_t{Kind: IdentifierMonth, Text: "August", Span: [13..19]}
[5] Trivia{Kind: Whitespace, Text: " ", Span: [19..20]}
[6] Token_t{Kind: Number, Text: "2025", Span: [20..24]}
[7] Trivia{Kind: Whitespace, Text: " ", Span: [24..25]}
[8] Token_t{Kind: LParen, Text: "(", Span: [25..26]}
[9] Token_t{Kind: Hash, Text: "#", Span: [26..27]}
[10] Token_t{Kind: Number, Text: "123", Span: [27..30]}
[11] Token_t{Kind: RParen, Text: ")", Span: [30..31]}
```
...
```
[0] Token_t{Kind: Identifier, Span: [0..7]  L1:C1 }      // "Currnet"
    TrailingTrivia: [Whitespace [7..9] "  "]

[1] Token_t{Kind: KeywordTurn, Span: [9..13]  L1:C10}    // "Turn"
    TrailingTrivia: [Whitespace [13..15] "  "]

[2] Token_t{Kind: Identifier, Span: [15..20] L1:C16}     // "Agust"
    TrailingTrivia: [Whitespace [20..21] " "]

[3] Token_t{Kind: Number, Span: [21..25] L1:C22}         // "2025"
    TrailingTrivia: [Whitespace [25..26] " "]

[4] Token_t{Kind: LParen, Span: [26..27] L1:C27}         // "("

[5] Token_t{Kind: Hash, Span: [27..28] L1:C28}           // "#"
[6] Token_t{Kind: Hash, Span: [28..29] L1:C29}           // "#"

[7] Token_t{Kind: Identifier, Span: [29..33] L1:C30}     // "12a3"
...
```
[0] Token_t{Kind: KeywordCurrent, Span: [0..7] L1:C1}
[1] Token_t{Kind: Comma, Span: [7..8] L1:C8}
[2] Token_t{Kind: Comma, Span: [8..9] L1:C9}
    TrailingTrivia: [Whitespace [9..11] "  "]

[3] Token_t{Kind: KeywordTurn, Span: [11..15] L1:C12}
    TrailingTrivia: [
        Whitespace   [15..16] " ",
...
[4] Token_t{Kind: MonthName, Span: [28..34] L1:C29}      // "August"
    TrailingTrivia: [Whitespace [34..37] "   "]

[5] Token_t{Kind: Number, Span: [37..41] L1:C38}         // "2025"
    TrailingTrivia: [Whitespace [41..43] "  "]

[6] Token_t{Kind: LParen, Span: [43..44] L1:C44}         // "("
[7] Token_t{Kind: Hash, Span: [44..45] L1:C45}
[8] Token_t{Kind: Number, Span: [45..48] L1:C46}         // "123"
[9] Token_t{Kind: RParen, Span: [48..49] L1:C49}         // ")"
[10] Token_t{Kind: RParen, Span: [49..50] L1:C50}        // stray ")"
```
...
Below is a **developer-facing, in-the-weeds spec** for the CST parser. It assumes you already grok lexing/parsing; the goal is to nail down *our* CST shapes, API, and the control flow (happy path first; errors + recovery after). No emojis, no fluff.

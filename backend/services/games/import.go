...
//	Turns       map[string]*GameTurnMeta_t `json:"turns,omitempty"`
//	SetupTurn   *GameTurn_t                `json:"-"`
//}
//
//type GameTurn_t struct {
//	Id    string `json:"id"`
...
//}
//
//type GameTurnMeta_t struct {
//	GameTurn_t
//	Active    bool   `json:"active,omitempty"`
//	OrdersDue string `json:"ordersDue,omitempty"`
//}
//
...
//	Id        string     `json:"id"`
//	Clan      int        `json:"clan"`
//	SetupTurn GameTurn_t `json:"setupTurn,omitempty"`
//}
//
...
//			if errSetup := domains.ValidateGameTurn(turn.Year, turn.Month); err != nil {
//				log.Printf("error: game %q: setup %d-%d: %v\n", game.Id, turn.Year, turn.Month, errSetup)
//				err = errSetup
//				continue
//			}
//			turn.Id = fmt.Sprintf("%04d-%02d", turn.Year, turn.Month)
//			if game.SetupTurn == nil || game.SetupTurn.No > turn.No {
//				game.SetupTurn = &GameTurn_t{
//					Id:    turn.Id,
//					Year:  turn.Year,
//					Month: turn.Month,
//					No:    turn.No,
